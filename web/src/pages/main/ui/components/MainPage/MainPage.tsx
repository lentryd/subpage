...
import { RemnawaveLogo } from '@/shared/ui/RemnawaveLogo'
import {
    AccordionBlockRenderer,
    CardsBlockRenderer,
    MinimalBlockRenderer,
    TimelineBlockRenderer,
} from '@/widgets/main/InstallationGuide/components/blocks'
import { InstallationGuideConnector } from '@/widgets/main/InstallationGuide/InstallationGuide'
import { RawKeysWidget } from '@/widgets/main/RawKeys'
import {
    SubscriptionInfoCardsWidget,
    SubscriptionInfoCollapsedWidget,
    SubscriptionInfoExpandedWidget,
} from '@/widgets/main/SubscriptionInfo'
import { SubscriptionLinkWidget } from '@/widgets/main/SubscriptionLink'
...
export const MainPage = ({ isMobile, platform }: IMainPageProps) => {
    ...
    const SubscriptionInfoBlockRenderer = SUBSCRIPTION_INFO_BLOCK_RENDERERS[config.uiConfig.subscriptionInfoBlockType]
    ...
    return (
        <Page>
            ...
            >
                <Stack gap="xl">
                    {SubscriptionInfoBlockRenderer && <SubscriptionInfoBlockRenderer isMobile={isMobile} />}
