...
import { Box, Button, ButtonVariant, Card, Group, NativeSelect, Stack, Title, UnstyledButton } from '@mantine/core'
...
import { IBlockRendererProps } from './components/blocks/rendererBlock.types'
...
export const InstallationGuideConnector = (props: IProps) => {
    ...
    const availablePlatforms = (Object.entries(hasPlatformApps) as [TSubscriptionPagePlatformKey, boolean][])
