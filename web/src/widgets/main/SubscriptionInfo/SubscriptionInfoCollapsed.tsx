...
import { Card, Collapse, Group, SimpleGrid, Stack, Text, ThemeIcon, UnstyledButton } from '@mantine/core'
import {
    IconAlertCircle,
    IconArrowsUpDown,
    IconCalendar,
                ...
                <Stack gap="xs" pb={{ base: 'xs', sm: 'sm' }} px={{ base: 'xs', sm: 'sm' }}>
                    <SimpleGrid cols={2} spacing="xs" verticalSpacing="xs">
                        ...
                        <InfoBlock
                            ...
                            value={
                                user.userStatus === 'ACTIVE' ? t(baseTranslations.active) : t(baseTranslations.inactive)
                            }
                        />
