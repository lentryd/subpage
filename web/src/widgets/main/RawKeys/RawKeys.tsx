...
import { ActionIcon, Badge, Box, Card, CopyButton, Group, Image, ScrollArea, Stack, Text, Title } from '@mantine/core'
import { modals } from '@mantine/modals'
import { IconCheck, IconCopy, IconKey, IconQrcode } from '@tabler/icons-react'

import classes from './RawKeys.module.css'
                                ...
                                <Box className={classes.keyRow}>
                                    <Box className={classes.keyInfo}>
                                        ...
                                        <Box className={classes.keyName}>
                                            <Text c="white" fw={500} size={isMobile ? 'xs' : 'sm'} span>
                                                {link.name}
                                            </Text>
                                        </Box>
                                    </Box>
